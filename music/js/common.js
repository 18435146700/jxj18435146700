...
//获取cookie中特定值
    function getCookie(cookieZ) {
        var cookieStr = document.cookie;   //name=zhangsan; age=18; sex=男
        var cookieArr = cookieStr.split("; "); //['name=zhangsan','age=18','sex=男']
        for(var i = 0; i < cookieArr.length; i++){
            var arr = cookieArr[i].split("=");//[['name','zhangsan'],['age','18'],['sex','男']]
            if(cookieZ == arr[0]){
                return arr[1];
            }
        }
